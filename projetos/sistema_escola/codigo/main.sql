...
-- 12: OCORRÊNCIAS (VISÃO PROFESSOR)
...
--18B: ALUNOS ENVOLVIDOS
select ocor.id, us.nome "Envolvidos", us.rs_ra "RA dos envolvidos" 
...
-- 19: CRIANDO/EDITANDO OCORRÊNCIA
	-- CRIANDO
    ...
    insert into Ocorrencias_alunos values (100, 2222204890);
    insert into Ocorrencias_alunos values (100, 2222204891);
	-- VISUALIZAÇÃO DOS ALUNOS ENVOLVIDOS
	...
	-- REMOÇÃO DE UM ALUNO DE UMA OCORRÊNCIA
	delete from Ocorrencias_alunos where id_ocor = 100 and ra = 2222204891;

	-- EDITANDO
		-- APAGAR UM ALUNO DE UMA OCORRÊNCIA
    	delete from Ocorrencias_alunos where id_ocor = 100 and ra = 2222204890;
		-- ALTERAÇÃO
