...
--- Tabela para turmas (turno 'M' = manhã, turno 'N' = noite)
...
--- Tabela para boletim (recebe tabela intermediária 'Prof_Turma' como FK, contendo as informações da turma, professor e disciplina)
